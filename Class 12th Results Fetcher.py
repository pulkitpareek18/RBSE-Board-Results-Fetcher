...
rollnos = [rollno for rollno in df['Roll No.']]
...
merger.write(os.path.join(os.getcwd(),"Output",f"RBSE Class 12th {streamNames[choice-1]} Result {df['Roll No.'][0]}-{df['Roll No.'][len(df['Roll No.'])-1]}.pdf"))
merger.close()
